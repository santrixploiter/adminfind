...
+-----------------------------------------+
|#Author:     MR.NICK                 |
|#Github= SantriXploiter              |
|#Status:WORKED                       |
|#Tool ini digunakan untuk pentesting |
|#Gunakan tool dengan bijak           |
|jangan pake otak vokep kalian yaa:v  |
| ^_^ !!!                             |
|#Respect Coderz ^_^                  |
|#ENJOYY                              |
+=========================================+
...
+-----------------------------------------+
''')
print(" \033[95m HARUS TULIS Protokol nya Dulu COEGG! HTTPS:// or HTTP:// ex: http://www.ex.com , ex :https://www.ex.com ")
print(" \033[95m Anda harus menulis / di ujung situs contoh: www.example.com/")
print("                                                                       ")
url = input("\033[97m TARGET : ")
...
for hani in passe :
    ...
    try :
        ...
        print("                                                             ")
        print("\033[92m ::: HALAMAN ADMIN DITEMUKAN ::: "+curl)
        print("_____________________________________________________________")
    except urllib.error.URLError as msg :
        print ("\033[91m **** MAAF TIDAK DITEMUKAN ::: "+curl)


print ("----------------------------------------------------------------------------------------")
print ("\033[93m     TERIMAKASIH TELAH MENGGUNAKAN TOOL INI -MR.NICK-")
print ("----------------------------------------------------------------------------------------")
